...
export const Projects = () => {
  const projects = {
    ...
    2:{
      "title": "ChatGPT Clone",
      "description": "Web application, creating a clone of the ChatGPT front-end. The application allows users to interact with the chatbot and receive responses generated by AI technology, integrating the CohereAI artificial intelligence system. ",
      "link-web": "",
      "img": [
    ...
    5:{
      "title": "PoetAI",
      "description": "Web application, where you can create a poem for any situation and dedicate it to anyone you want. It offers a wide range of poem types to choose from. Select the type of poem and the name of the person you want to dedicate it to, and the AI will generate it for you.",
      "link-web": "",
      "img": [
  ...
  return (
    <>
      <div className='Projects' id="projects">
        ...
        <a className='bttn-projects' href="https://github.com/jjlorente?tab=repositories" target="_blank">See all projects <i className="fab fa-github i-projects"></i></a>
      </div>
